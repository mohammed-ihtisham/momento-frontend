          ...
          <section class="photo-board-section">
            ...
            <div v-if="showPhotoForm" class="photo-form-container">
              <div class="photo-form">
                <h3 class="photo-form-title">Upload Photo</h3>
                <div class="photo-form-field">
                  <label class="photo-form-label">Select Image</label>
                  <input
                    ref="photoFileInput"
                    type="file"
                    accept="image/*"
                    @change="handleFileSelect"
                    class="photo-form-input"
                  />
                  <p v-if="selectedFile" class="photo-form-selected">
                ...
                <div class="photo-form-actions">
                  <button
                    ...
                    class="photo-form-button photo-form-button-secondary"
                  ...
                  <button
                    ...
                    class="photo-form-button photo-form-button-primary"
